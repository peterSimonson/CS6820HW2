...
void Table::GenerateRules() {
    ...
    addRule(LINE_FULL_TOKEN,         {VAR_TYPE, VAR_TYPE_TOKEN});
    addRule(LINE_FULL_TOKEN,         {LINE_VAR_NAME});
    addRule(LINE_FULL_TOKEN,         {NUM_TOKEN, POWER_PRIME_TOKEN, MULT_DIV_PRIME_TOKEN, ADD_SUB_PRIME_TOKEN});
    addRule(LINE_FULL_TOKEN,         {NEG_NUM_TOKEN, POWER_PRIME_TOKEN, MULT_DIV_PRIME_TOKEN, ADD_SUB_PRIME_TOKEN});
    addRule(LINE_FULL_TOKEN,         {PARENS_EXPR_TOKEN, POWER_PRIME_TOKEN, MULT_DIV_PRIME_TOKEN, ADD_SUB_PRIME_TOKEN});
    addRule(LINE_FULL_TOKEN,         {RETURN_TOKEN, EXPR_TOKEN});
    addRule(LINE_FULL_TOKEN,         {CLOSE_CURLY_TOKEN});
    addRule(VAR_TYPE_TOKEN,          {LINE_VAR_NAME});
    addRule(VAR_TYPE_TOKEN,          {PROCEDURE_TOKEN, NAME_TOKEN, PROCEDURE_PARAMS_TOKEN, OPEN_CURLY_TOKEN}); 
    addRule(LINE_VAR_NAME,           {NAME_TOKEN, LINE_VAR_NAME_REMAINING});
    addRule(LINE_VAR_NAME,           {NEG_NAME_TOKEN, LINE_VAR_NAME_REMAINING});
    ...
    addRule(PARAMS_TOKEN,            {VAR_TYPE, NAME_TOKEN, MORE_PARAMS_TOKEN});
    addRule(PARAMS_TOKEN,            {EPSILON_TOKEN});
    addRule(MORE_PARAMS_TOKEN,       {OPEN_PAREN_TOKEN, VAR_TYPE, NAME_TOKEN, MORE_PARAMS_TOKEN});
    ...
    addRule(PARENS_EXPR_TOKEN,       {OPEN_PAREN_TOKEN, EXPR_TOKEN, CLOSE_PAREN_TOKEN});
    addRule(PARENS_EXPR_TOKEN,       {MINUS_TOKEN, OPEN_PAREN_TOKEN, EXPR_TOKEN, CLOSE_PAREN_TOKEN});
