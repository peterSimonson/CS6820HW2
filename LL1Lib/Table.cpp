...
void Table::GenerateRules() {
    ...
    addRule(LINE_FULL_TOKEN,         {PRINT_NUM_TOKEN, NAME_TOKEN});
    addRule(LINE_FULL_TOKEN,         {PRINT_ISH_TOKEN, NAME_TOKEN});
    addRule(LINE_FULL_TOKEN,         {PRINT_STRING_TOKEN, STRING_TOKEN});
    addRule(LINE_FULL_TOKEN,         {READ_NUM_TOKEN, NAME_TOKEN});
