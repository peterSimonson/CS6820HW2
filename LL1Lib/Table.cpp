...
void Table::GenerateRules() {
    ...
    addRule(PROCEDURE_PARAMS_TOKEN,  {OPEN_PARAN_TOKEN, PARAMS_TOKEN, CLOSE_PARAN_TOKEN});
    addRule(PARAMS_TOKEN,            {VAR_TYPE, NAME_TOKEN, MORE_PARAMS_TOKEN});
    addRule(PARAMS_TOKEN,            {EPSILON_TOKEN});
    addRule(MORE_PARAMS_TOKEN,       {OPEN_PARAN_TOKEN /*COMMA_TOKEN*/, VAR_TYPE, NAME_TOKEN, MORE_PARAMS_TOKEN});
    ...
    addRule(PARENS_EXPR_TOKEN,       {MINUS_TOKEN, OPEN_PARAN_TOKEN, EXPR_TOKEN, CLOSE_PARAN_TOKEN});
