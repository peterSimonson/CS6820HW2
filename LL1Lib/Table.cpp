...
void Table::GenerateRules() {
    ...
    addRule(PROCEDURE_ARGS_TOKEN,    {OPEN_PAREN_TOKEN, ARGS_TOKEN, CLOSE_PAREN_TOKEN});//17
    addRule(PROCEDURE_ARGS_TOKEN,    {EPSILON_TOKEN});
    addRule(ARGS_TOKEN,              {NAME_TOKEN, MORE_ARGS_TOKEN});//18
    addRule(ARGS_TOKEN,              {NEG_NAME_TOKEN, MORE_ARGS_TOKEN});//18
    addRule(ARGS_TOKEN,              {SPACE_NEG_NAME_TOKEN, MORE_ARGS_TOKEN});//18
    addRule(ARGS_TOKEN,              {NUM_TOKEN, MORE_ARGS_TOKEN});//18
    addRule(ARGS_TOKEN,              {NEG_NUM_TOKEN, MORE_ARGS_TOKEN});//18
    addRule(ARGS_TOKEN,              {SPACE_NEG_NUM_TOKEN, MORE_ARGS_TOKEN});//18
    addRule(ARGS_TOKEN,              {EPSILON_TOKEN});//19
    addRule(MORE_ARGS_TOKEN,         {COMMA_TOKEN, ARGS_TOKEN});//20
    addRule(MORE_ARGS_TOKEN,         {EPSILON_TOKEN});//21
    ...
    addRule(POSVAL_TOKEN,            {NAME_TOKEN, PROCEDURE_ARGS_TOKEN});//48
