...
#define EXPR_TOKEN 5
#define L_TERM_ADDSUB_TOKEN 6
#define R_TERM_ADDSUB_TOKEN 7
#define ADDSUB_PRIME_TOKEN 8
#define L_TERM_MULTDIV_TOKEN 9
#define R_TERM_MULTDIV_TOKEN 10
#define MULTDIV_PRIME_TOKEN 11
#define MULT_AND_RIGHTOP_TOKEN 12
#define DIV_AND_RIGHTOP_TOKEN 13
#define L_TERM_POWER_TOKEN 14
#define R_TERM_POWER_TOKEN 15
#define POWER_PRIME_TOKEN 16
#define POWER_AND_RIGHTOP_TOKEN 17
#define G_FACTOR_TOKEN 18
#define PARENS_EXPR_TOKEN 19
#define POSVAL_TOKEN 20
#define SPACE_NEG_VAL_TOKEN 21
#define VAR_TYPE 22
//Define Columns of our table
#define NUM_OF_NON_TERMINALS 23
#define END_TOKEN 23
#define EQUALS_TOKEN 24
#define PLUS_TOKEN 25
#define MINUS_TOKEN 26
#define MULTIPLY_TOKEN 27
#define DIVIDE_TOKEN 28
#define POWER_TOKEN 29
#define OPEN_PARAN_TOKEN 30
#define CLOSE_PARAN_TOKEN 31
#define NAME_TOKEN 32
#define NUM_TOKEN 33
#define SPACE_NEG_NAME_TOKEN 34
#define SPACE_NEG_NUM_TOKEN 35
#define NEG_NAME_TOKEN 36
#define NEG_NUM_TOKEN 37
#define DATA_TYPE_TOKEN 38
#define EPSILON_TOKEN 39
//TODO: Change where this is used so it is the number of tokens not number of tokens - 1
#define NUM_OF_TOKENS 39
